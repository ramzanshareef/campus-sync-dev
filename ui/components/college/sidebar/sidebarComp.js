...
const Sidebar = ({ }) => {
    ...
    return (
        <>
            ...
            <aside className={` absolute left-0 top-0 z-9999 flex h-screen flex-col overflow-y-hidden bg-[#1C2434] max-md:w-60 md:w-72 duration-300 ease-linear lg:static lg:translate-x-0 text-white font 
            ...
            >
                ...
                <nav className="flex-1 scroll-auto overflow-y-scroll scrollbar-hide">
                    <ul className="px-4 py-2">
                        <li className="hover:bg-gray-700 hover:rounded-md px-4 py-2">
                            <Link href="/college/dashboard" className="flex items-center gap-x-4">
                        ...
                        <li className="hover:bg-gray-700 hover:rounded-md px-4 py-2">
                            <Link href="/college/students" className="flex items-center gap-x-4">
                                <svg className="fill-current" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M13.5 0H4.5C3.67157 0 3 0.671573 3 1.5V16.5C3 17.3284 3.67157 18 4.5 18H13.5C14.3284 18 15 17.3284 15 16.5V1.5C15 0.671573 14.3284 0 13.5 0ZM4.5 1.5H13.5V16.5H4.5V1.5ZM9 3C10.1046 3 11 3.89543 11 5C11 6.10457 10.1046 7 9 7C7.89543 7 7 6.10457 7 5C7 3.89543 7.89543 3 9 3ZM9 8C11.2091 8 13 9.79086 13 12H5C5 9.79086 6.79086 8 9 8Z" fill=""></path></svg>
                                <span>Students</span>
                            </Link>
                        </li>
                    </ul>
