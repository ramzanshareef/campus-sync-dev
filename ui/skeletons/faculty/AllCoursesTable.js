            ...
            <table className="max-md:win-w-full md:w-5/6 mx-auto text-gray-900 overflow-x-scroll" id="myProducts">
                <thead className="rounded-lg text-left text-sm font-normal overflow-x-auto">
                    <tr>
                        ...
                        <th className="px-4 py-5 text-center">Code</th>
                        <th className="px-4 py-5 text-center">Description</th>
                        <th className="px-4 py-5 text-center">No of Students</th>
...
export default AllCoursesTableSkeleton;