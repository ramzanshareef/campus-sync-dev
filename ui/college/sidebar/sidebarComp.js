            ...
            >
                ...
                <nav className="flex-1 scroll-auto overflow-y-scroll scrollbar-hide">
                    <ul className="px-4 py-2">
                        <li className={` hover:bg-gray-700 hover:rounded-md px-4 py-2 ${pathname.includes("/college/dashboard") ? "bg-gray-700 rounded-md" : ""} `}>
                        ...
                        <li className={` hover:bg-gray-700 hover:rounded-md px-4 py-2 ${pathname.includes("/college/students") ? "bg-gray-700 rounded-md" : ""} `}>
