            ...
            >
                ...
                <nav className="flex-1 scroll-auto overflow-y-scroll scrollbar-hide">
                    <ul className="px-4 py-2">
                        ...
                        <li className={` hover:bg-gray-700 hover:rounded-md px-4 py-2 ${pathname.includes("/college/faculty") ? "bg-gray-700 rounded-md" : ""} `}>
                            <Link href="/college/faculty" className="flex items-center gap-x-4">
