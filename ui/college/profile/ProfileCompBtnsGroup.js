    ...
    return (
        <div className="flex flex-row flex-wrap">
            <button
                ...
                ${pathname === "/college/profile" ? "bg-indigo-500 hover:bg-indigo-700 text-white" : "hover:text-indigo-600"}
                `}
                onClick={() => {
                    router.refresh();
                }}
            ...
            <button
                className={`py-2 px-4 rounded-md my-4 mr-2 flex gap-x-1 items-center 
                ${pathname === "/college" ? "bg-indigo-500 hover:bg-indigo-700 text-white" : "hover:text-indigo-600"}
                `}
                onClick={() => {
                    router.push("/college");
                }
