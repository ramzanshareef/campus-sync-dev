...
const ProfileForm = ({ college }) => {
    const [state, personalInfoUpdateHandler] = useFormState(updateCollegeDetails, null);
    const [passwordState, passwordUpdateHandler] = useFormState(updateCollegePassword, null);
                ...
                <div className="flex flex-col gap-y-4">
                    <div className="flex flex-row gap-x-2">
                        <h2 className="text-lg font-bold flex flex-row items-center gap-x-2">
                            <LiaUniversitySolid className="text-2xl inline-flex" />
                            College Information
                        </h2>
                    </div>
                    <form
                        ...
                        <div className="flex flex-col space-y-4 max-md:text-sm">
                            <div className="flex flex-col space-y-1 md:space-y-2">
                                ...
                                <input
                                    ...
                                    required={true}
                                    minLength={3}
                                    defaultValue={college?.college === "N/A" ? "Please Enter College Name Here" : college?.college}
                                />
                            </div>
