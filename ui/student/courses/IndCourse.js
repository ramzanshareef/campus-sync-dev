...
import IndCourseQuizComp from "./IndCourseQuizComp";
import IndCourseQuizResults from "./IndCourseQuizResults";

const IndCourse = async ({ courseData, quizAttempts }) => {
    let quizzes = await courseData.quizzes;
    ...
    return (
        <>
            <div>
                ...
                <IndCourseQuizComp quizzes={quizzes} />
                <IndCourseQuizResults
                    course={courseData}
                    quizzesResults={quizAttempts} />
            </div>
        </>
    );
};
...
IndCourse.propTypes = {
    ...
    quizAttempts: PropTypes.array.isRequired
};